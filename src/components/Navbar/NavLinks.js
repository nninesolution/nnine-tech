...
const NavLinks = () => {
    return (
        <>
            ...
            <Link className="font-bold text-blue-900 hover:bg-blue-100 inline-block md:inline-flex items-center justify-center w-auto px-4 py-2 rounded-xl" target='_blank' to="#">
                Trainings
            </Link>
